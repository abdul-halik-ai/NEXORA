...
export const mockTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    college: 'VIT Vellore',
    role: 'MCA Student',
    comment: 'I requested a custom Blockchain voting script. The Nexora developers delivered it in 5 days, within my tight student budget, and explained the smart contract deployment step-by-step.',
    rating: 5,
